...
class RegistrationTest {
    ...
    fun `when mail is not valid registration should not be legitimate and therefore error message should be about mail`(){
        val registration = Registration("testpassword123","testpassword123","notvalidMail@gmailcom","TestName","TestLastName")
        val anotherRegistration = Registration("testpassword123","testpassword123","notvalidMailgmail.com","TestName","TestLastName")
    ...
    fun `when mail is valid format but passwords are not same registration should not be legitimate and error should be about passwords being different`(){
        val registration = Registration("testpassword123","testpasd123","validMail@gmail.com","TestName","TestLastName")
        assertEquals(registration.isLegit(),false)
    ...
    fun `when mail is valid, passwords same, but not long enough error should be about that`(){
        val registration = Registration("tes1","tes1","validMail@gmail.com","TestName","TestLastName")
        assertEquals(registration.isLegit(),false)
    ...
    fun `when everything is valid but passsword doesnt contain digit error should be about that`(){
        val registration = Registration("testtest","testtest","validMail@gmail.com","TestName","TestLastName")
        assertEquals(registration.isLegit(),false)
    ...
    fun `when everything is ok but password is only digits error should be about that`(){
        val registration = Registration("123456789","123456789","validMail@gmail.com","TestName","TestLastName")
        assertEquals(registration.isLegit(),false)
    ...
    fun `when everything is valid registartion should be legit`(){
        val registration = Registration("test123456789","test123456789","validMail@gmail.com","TestName","TestLastName")
